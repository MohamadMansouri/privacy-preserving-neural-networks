...
model = "../2pc_model_FP_SIMD"
signal = "./input/signal_pca"
...
proc = ["./client", "-a" ,"155.246.81.27", "-p", "9999", "-s", signal]
print (" ".join(proc))

for i in range(repeat):
	print("{} / {}".format(i + 1,repeat))
#	result = subprocess.check_output(["./server", "-p", "9999")

	result = subprocess.check_output(proc)
